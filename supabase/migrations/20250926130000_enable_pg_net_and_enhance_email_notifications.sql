-- Enable pg_net extension for email notifications (creates net schema automatically)
CREATE EXTENSION IF NOT EXISTS pg_net;

-- Enhanced email notification system with proper templates
...
-- Enhanced booking status change handler with proper email templates
...
-- Enhanced new booking handler with HOD notification
